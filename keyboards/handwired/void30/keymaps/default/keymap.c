...
[_QWERTY] = LAYOUT_ortho_3x10(
    ...
    LCTL_T(KC_Z),  LALT_T(KC_X),  LGUI_T(KC_C), LT(_FN3, KC_V), LT(_FN2, KC_B), LT(_FN1, KC_SPC), LT(_FN4, KC_N), RALT_T(KC_M), RCTL_T(KC_M), LGUI_T(KC_BSPC)
),
...
[_FN1] = LAYOUT_ortho_3x10(
    ...
    RESET, KC_TRNS, KC_TRNS, KC_TRNS, KC_ESC, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS
),
